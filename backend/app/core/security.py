...
def verify_password(
    ...
    Passwords longer than 72 bytes cannot be valid bcrypt passwords.
    """
...
def create_refresh_token(
    ...
    """
    Refresh tokens live much longer and carry a 'type' claim
...
def decode_access_token(
    ...
    """
    Returns the subject (user id string) if the token is
    a valid, non-expired access token, else None.

    Rejects refresh tokens even if otherwise valid.
    """
...
def decode_refresh_token(
    ...
    """
    Returns the subject (user id string) if the token is
    a valid, non-expired refresh token, else None.

    Rejects access tokens even if otherwise valid.
    """
